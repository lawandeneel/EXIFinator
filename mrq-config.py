...
"""
TRACE_GREENLETS = True #Collect stats about each greenlet execution time and switches.Defaults to False.
...
MAX_MEMORY = 1000000 #Max memory (in Mb) after which the process will be shut down. Use with PROCESS = [1-N] to have supervisord automatically respawn the worker when this happens.Defaults to 1
GREENLETS = 100 #Max number of greenlets to use.Defaults to 1.
